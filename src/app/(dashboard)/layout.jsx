...
// import { ClipboardList, PlusCircle, FolderHeart, LogOut, Menu, Sun, Moon, LayoutDashboard } from "lucide-react";
...
//       {/* Sidebar Container */}
//       <aside className="w-64 bg-[#f8f3e9] dark:bg-[#162224] border-r border-slate-200 dark:border-slate-800/60 flex flex-col justify-between p-4  md:flex sticky top-0 h-screen z-20 transition-colors duration-300">
